...
def layer(inputs1, weight_shape):
...
A=500
def inference_deep(inputs1, A):
    with tf.variable_scope("predict1", "Qout1", "W1"):
        predict1, Qout1, W1 = layer(inputs1, [500, 250])
    with tf.variable_scope("predict2", "Qout2", "W2"):
        predict2, Qout2, W2 = layer(Qout1, [250, 250])
    with tf.variable_scope("predict", "Qout", "W"):
        predict, Qout, W = layer(Qout2, [250, 6])
    return predict, Qout, W
...
predict, Qout, W = inference_deep(inputs1,500)
